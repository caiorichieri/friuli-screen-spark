      ...
      <div className="grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-5">
          ...
          <h2 className="text-4xl uppercase leading-[0.95] md:text-6xl">
            Il punto d'incontro tra <span className="text-friuli-blue">tradizione</span>,
            innovazione e <span className="text-friuli-blue">comunità</span>.
          </h2>
        </div>
        <div className="space-y-6 text-lg leading-relaxed text-ink/80 lg:col-span-7">
          <p>
            Friuli On nasce per rendere la pubblicità locale più accessibile, efficace e
            sostenibile. Connettiamo imprese e comunità in modo diretto, moderno e profondamente
            territoriale.
          </p>
          <p>
            Guardiamo oltre il dolce. Una mano che stringe un pirulito può sembrare un gesto
            quotidiano, ma per noi ogni dettaglio racconta una storia, comunica un'idea, evoca
            un'emozione. Esploriamo, interpretiamo, creiamo. <strong>Insieme.</strong>
          </p>
