...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Monitor TV indoor in bar, farmacie e palestre del Friuli, più SEO, Google e Meta ADS, grafica e siti web per aziende locali." },
      ...
      { property: "og:description", content: "Monitor TV indoor in bar, farmacie e palestre del Friuli, più SEO, Google e Meta ADS, grafica e siti web per aziende locali." },
      { name: "twitter:description", content: "Monitor TV indoor in bar, farmacie e palestre del Friuli, più SEO, Google e Meta ADS, grafica e siti web per aziende locali." },
      {
